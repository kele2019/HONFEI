<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminApproval.aspx.cs" Inherits="Presale.Process.Traval.AdminApproval" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function submitPageReview(obj) {
            ...
            $("#ButtonList1_btnSubmit").val("Confirm Complete？");
...
Time</th>
        ...
        <td align="center"  >
            <table>
                <tr>
                    <td> 
                    <input type="button"  class="btn" value="完成\Complete" onclick="submitPageReview('0')" />
                    </td>
                    </tr>
                    </table>
                    </td>
