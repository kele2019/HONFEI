<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectList1.aspx.cs" Inherits="Presale.Process.LocalExpense.ProjectList1" %>
...
<body>
    ...
    <div>
            ...
            <asp:Repeater runat="server" ID="ProjectList">
                <ItemTemplate>
                    <tr>
                        ...
                        <td style="text-align:center">
                            <asp:Label runat="server" ID="ProjectValue" Text='<%#Eval("ProjectValue") %>'></asp:Label>
                        </td>
                        <td style="text-align:center">
        ...
        <asp:TextBox ID="ProjectValue" runat="server" style="display:none;"></asp:TextBox>
        ...
        <div class="center">
            ...
            <input type="button" value="Cancel" class="btn" onclick="CloseForm()" style="height: 25px;" />
        </div>
    </div>
    </form>
</body>
