<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HRFinish.aspx.cs" Inherits="Presale.Process.VoluntaryResignation.HRFinish" %>
    ...
    <form id="form1" runat="server">
     <div id="myDiv" class="container">
            <div class="row">
                ...
                <asp:TextBox runat="server" ID="fld_ProcessStatus" style="display:none;"></asp:TextBox>
            </div>
            <div class="row">
