	...
	public partial class NewRequest : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			if (!IsPostBack)
			{
                ...
                string gmgode = DataAccess.Instance("BizDB").ExecuteScalar("select USERCODE from dbo.ORG_USER where LOGINNAME=( SELECT top(1) UserAccount FROM  [dbo].[ORG_ROLEINFO] where RoleName='GM')").ToString();
