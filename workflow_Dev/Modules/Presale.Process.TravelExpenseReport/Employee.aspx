<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Employee.aspx.cs" Inherits="Presale.Process.TravelExpenseReport.Employee" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function getButtonCheck(obj) {
            var EmployeeCode = $(obj).parent().next().children().text();
            $("#EmployeeCode").val(EmployeeCode);
            var EmployeeName = $(obj).parent().next().next().children().text();
            $("#EmployeeName").val(EmployeeName);
        }
        function SinglePersonConfirm() {
            var returnJson = "[{'EmployeeCode':'";
            returnJson += $("#EmployeeCode").val();
            returnJson += "'},{'EmployeeName':'";
            returnJson += $("#EmployeeName").val();
            returnJson += "'}]";
            //            alert(returnJson);
    ...
    <div>
        ...
        <table class="table table-condensed table-bordered" >
                <tr>
                    ...
                    <td class="td-content"><asp:DropDownList runat="server"  Width="50%"
                            ID="dropDepartment" 
                            onselectedindexchanged="dropDepartment_SelectedIndexChanged" 
                            AutoPostBack="True" ></asp:DropDownList></td>
                    <td class="td-label" >Employee Name</td>
                    <td class="td-content"><asp:DropDownList ID="dropEmployee" Width="50%" runat="server"></asp:DropDownList>
        ...
        <table class="table table-condensed table-bordered">
            <tr>
                <th style="Width:2%;"></th>
                <th style="Width:39%;">Vendor Code</th>
                <th style="Width:39%;">Vendor Name</th>
        ...
        <asp:TextBox ID="EmployeeCode" runat="server" style="display:none;"></asp:TextBox>
        <asp:TextBox ID="EmployeeName" runat="server" style="display:none;"></asp:TextBox>
        </div>
        <div class="center">
