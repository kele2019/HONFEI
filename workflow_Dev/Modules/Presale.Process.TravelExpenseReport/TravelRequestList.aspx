<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TravelRequestList.aspx.cs" Inherits="Presale.Process.TravelExpenseReport.TravelRequestList" %>
...
<head id="Head1" runat="server">
    ...
    <title>TravelRequestDetails</title>
    <script type="text/javascript" src="/Assets/js/common.js"></script>
    <script type="text/javascript">
        function getButtonCheck(obj) {
            var value = $(obj).parent().next().children().text();
            $("#TravelRequstNo").val(value);
        }
        function SinglePersonConfirm() {
            var returnJson = "[{'TravelRequstNo':'";
            returnJson += $("#TravelRequstNo").val();
            returnJson += "'}]";
            //            alert(returnJson);
...
<body>
    ...
    <div>
        ...
        <table class="table table-condensed table-bordered">
            <tr>
                <td width="10%"></td>
                <td width="30%" style="text-align:center">Travel Request NO.</td>
                <td width="30%" style="text-align:center">Applier</td>
                <td width="30%" style="text-align:center">Department</td>
            </tr>
            <tbody>
        ...
        <asp:TextBox ID="TravelRequstNo" runat="server" style="display:none;"></asp:TextBox>
        </div>
        <div class="center">
