...
{
	public partial class TravelRequestList : System.Web.UI.Page
	{
		...
		public void repeaterbind()
		{
			...
			string sql = "select * from ( select DOCUMENTNO,APPLICANT,DEPARTMENT FROM PROC_Travel where status='2' and TravelExpStatus = 0) B";
