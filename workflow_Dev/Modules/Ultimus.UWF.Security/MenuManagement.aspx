<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MenuManagement.aspx.cs"
    Inherits="Ultimus.UWF.Security.MenuManagement" %>
...
<body>
    ...
    <div class="pt10">
        <div class="row-fluid">
            ...
            <div class="span5" id="divInfo" runat="server" visible="false">
                <table class="table table-condensed table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="td-content">
                            <asp:TextBox ID="txtMenuId" ReadOnly="true" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="td-label">
                    ...
                    <tr>
                        ...
                        <td class="td-content">
                            <asp:TextBox ID="txtUrl" runat="server" TextMode="MultiLine" Height="40"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="td-label">
                    ...
                    <tr>
                        ...
                        <td class="td-content">
                            <asp:CheckBox ID="cbxIsHomePage" runat="server"></asp:CheckBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="td-label">
            ...
            <div class="span4" style="overflow: scroll; border: 1px solid; height: 420px;"  id="divExt" runat="server" visible="false">
                <table class="table table-condensed table-bordered">
                    ...
                    <tr>
                        <td class="td-label">
                            <asp:Label ID="lblExt29" runat="server" Text="扩展29："></asp:Label>
                            
                        </td>
                        <td class="td-content">
                            <asp:TextBox ID="txtExt29" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="td-label">
                            <asp:Label ID="lblExt30" runat="server" Text="扩展30："></asp:Label>
