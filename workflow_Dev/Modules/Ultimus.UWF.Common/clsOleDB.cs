...
namespace BPM
{
    ...
    public class clsOleDB
    {
        ...
        public clsOleDB(string strCnn)
        {
            ...
            this.pthSql = ConfigurationManager.AppSettings["SQLConfigPath"].ToString();
            this.isDebug = getConn("isDebug");
        }

        public clsOleDB()
        {
            this.pthCnn = "D:\\UltimusBPM\\ConfigFile\\cnnQuanyou.txt";
            this.pthLog = @"C:\logQuanYou " + System.DateTime.Now.ToString("yyyy-MM-dd") + ".txt";
            this.pthSql = "D:\\UltimusBPM\\ConfigFile\\sqlQuanYou.txt";
            this.isDebug = getConn("isDebug");
        }
        #endregion
