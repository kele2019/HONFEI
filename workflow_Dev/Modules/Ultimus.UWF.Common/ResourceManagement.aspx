<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResourceManagement.aspx.cs"
    Inherits="Ultimus.UWF.Common.ResourceManagement" %>
...
<body>
    ...
    <div class="pt10">
        <div class="row-fluid">
            <div class="span4">
                <asp:Literal ID="litType" runat="server" Text="类型："></asp:Literal><asp:DropDownList 
                    ID="ddlType" runat="server" AutoPostBack="True" 
