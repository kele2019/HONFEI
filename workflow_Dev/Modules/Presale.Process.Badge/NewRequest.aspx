<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewRequest.aspx.cs" Inherits="Presale.Process.Badge.NewRequest" %>
...
<head id="Head1" runat="server">
    ...
    <title>Badge Application Process</title>
    ...
    <script type="text/javascript">
        ...
        function beforeSubmit() {
            ...
            if ($("#access1").attr("checked")) {
             ...
             var summary = "Badge Application Process";
...
<body>
    <form id="form1" runat="server">
     <div id="myDiv" class="container">
            <%--<p style="text-decoration:underline;float:right;color:Blue">Request Operation Explain</p>--%>
            <div class="row">
                <ui:userinfo id="UserInfo1" processtitle="Badge Application Process" processprefix="BA" tablename="PROC_Badge"
                    ...
                    <tr>
                       ...
                       <span style=" background:red;  height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="7" >
                            ...
                            <asp:TextBox runat="server" ID="fld_Access" style="display:none"></asp:TextBox>
