<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Approval.aspx.cs" Inherits="Presale.Process.Personal_Allowance.Approval" %>
...
<body>
    ...
    <div id="myDiv" class="container">
        ...
        <div class="row">
            ...
            <asp:Repeater runat="server" ID="fld_detail_PROC_PersonalAllownce_DT"  OnItemDataBound="fld_detail_PROC_TravalExpense_DT_ItemDataBound">
            <ItemTemplate>
            <tr>
            ...
            <td>
            <asp:Label runat="server" ID="read_PaymentDate"  Text='<%# String.IsNullOrEmpty(Eval("PaymentDate").ToString())? "":DateTime.Parse(Eval("PaymentDate").ToString()).ToString("yyyy-MM")  %>' ></asp:Label>
            </td>
           <%-- <td>
