<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewRequest.aspx.cs" Inherits="采购申请3.NewRequest" %>
    ...
    <div class="container">
        <div class="row">
            <ui:userinfo id="UserInfo1" processtitle="采购申请3" processprefix="FP" tablename="PROC_采购申请3"
                tablenamedetail="PROC_采购申请3_ITEM" runat="server"></ui:userinfo>
        </div>
        <div class="row">
                ...
                <tr>
                    <td class="banner" colspan="4">
					 ...
					 <tr>
						...
						<td class="td-content">
								 <asp:TextBox ID="fld_day" runat="server" ></asp:TextBox>
						</td>
						<td class="td-label">
							level：
						</td>
						<td class="td-content">
								 <asp:TextBox ID="fld_level" runat="server" ></asp:TextBox>
					 ...
					 <tr>
						...
						<td class="td-content">
								 <asp:TextBox ID="fld_Jiaqian" runat="server" ></asp:TextBox>
						</td>
					<td class="td-label">
						</td>
						<td class="td-content">
				...
				<tr>
                    <td colspan="10">
                        <table class="table table-condensed table-bordered tablerequired">
                            ...
                            <asp:Repeater ID="fld_detail_PROC_采购申请3_Item" runat="server" OnItemCommand="fld_detail_PROC_采购申请3_Item_ItemCommand">
                                <ItemTemplate>
                                    <tr>
                                        <td class="hidden">
