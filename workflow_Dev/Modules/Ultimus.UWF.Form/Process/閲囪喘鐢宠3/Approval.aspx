<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Approval.aspx.cs" Inherits="采购申请3.Approval" %>
...
<body>
    ...
    <div class="container">
        <div class="row">
            <ui:userinfo id="UserInfo1" processtitle="采购申请3" processprefix="FP" tablename="PROC_采购申请3"
                tablenamedetail="PROC_采购申请3_ITEM" ReadOnly="true" runat="server"></ui:userinfo>
        </div>
        <div class="row">
                ...
                <tr>
                    <td class="banner" colspan="4">
					 ...
					 <tr>
						...
						<td class="td-content">
							<asp:Label ID="read_day" runat="server" CssClass="validate[ustom[number]]" />
						</td>
						<td class="td-label">
							level：
						</td>
						<td class="td-content">
							<asp:Label ID="read_level" runat="server" CssClass="validate[ustom[number]]" />
						</td>
					 </tr>
					 <tr>
						<td class="td-label">
					 ...
					 <tr>
						...
						<td class="td-content">
							<asp:Label ID="read_Jiaqian" runat="server" CssClass="validate[ustom[number]]" />
						</td>
					<td class="td-label">
						</td>
						<td class="td-content">
				...
				<tr>
                    <td colspan="10">
                        <table class="table table-condensed table-bordered tablerequired">
                            ...
                            <asp:Repeater ID="read_detail_PROC_采购申请3_Item" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        <td class="hidden">
