<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewRequest.aspx.cs" Inherits="采购申请1.NewRequest" %>
...
<body>
    ...
    <div class="container">
        <div class="row">
            <ui:userinfo id="UserInfo1" processtitle="采购申请1" processprefix="FP" tablename="PROC_采购申请1"
                tablenamedetail="PROC_采购申请1_ITEM" runat="server"></ui:userinfo>
        </div>
        <div class="row">
				...
				<tr>
                    <td colspan="10">
                        <table class="table table-condensed table-bordered tablerequired">
                            ...
                            <asp:Repeater ID="fld_detail_PROC_采购申请1_Item" runat="server" OnItemCommand="fld_detail_PROC_采购申请1_Item_ItemCommand">
                                <ItemTemplate>
                                    <tr>
                                        <td class="hidden">
