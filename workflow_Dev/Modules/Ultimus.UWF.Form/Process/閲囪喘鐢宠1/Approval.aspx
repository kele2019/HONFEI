<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Approval.aspx.cs" Inherits="采购申请1.Approval" %>
    ...
    <div class="container">
        <div class="row">
            <ui:userinfo id="UserInfo1" processtitle="采购申请1" processprefix="FP" tablename="PROC_采购申请1"
                tablenamedetail="PROC_采购申请1_ITEM" ReadOnly="true" runat="server"></ui:userinfo>
        </div>
        <div class="row">
				...
				<tr>
                    <td colspan="10">
                        <table class="table table-condensed table-bordered tablerequired">
                            ...
                            <asp:Repeater ID="read_detail_PROC_采购申请1_Item" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        <td class="hidden">
