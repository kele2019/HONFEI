<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Approval.aspx.cs" Inherits="Presale.Process.PersonalExpense.Approval" %>
        ...
        <div class="row">
            <ui:userinfo id="UserInfo1" processtitle="个人报销流程（Personal Expense Request）" processprefix="PE" tablename="PROC_PersonalExpense"
                ...
                <table class="table table-condensed table-bordered"   >
                 <tr>
                <td class="td-label" style="width:80px;">事由 Description：</td>
                <td colspan="3">
