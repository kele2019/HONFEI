...
(function ($) {
    ...
    var methods = {
        ...
        attach: function (userOptions) {
            ...
            if (!options.binded) {
                if (options.bindMethod == "bind") {
                    ...
                    // bind form.submit
                    if (options.submitNeedValidation) {
        ...
        */
        ...
        isValidate: function (userOption) {
            var options = $(this).data('jqv');
            jQuery.extend(options, userOption);
            return methods._validateFields(this);
        },
        /**
        ...
        */
        _buildPrompt: function (field, promptText, type, ajaxed, options) {
            ...
            if (options.showArrow) {
                ...
                switch (positionType) {
                    ...
                    case "bottomRight":
                        ...
                        arrow.addClass("formErrorArrowBottom").html('<div class="line1"><!-- --></div><div class="line2"><!-- --></div><div class="line3"><!-- --></div><div class="line4"><!-- --></div><div class="line5"><!-- --></div>');
                        break;
                    case "topLeft":
                    case "topRight":
                        arrow.html('<div class="line5"><!-- --></div><div class="line4"><!-- --></div><div class="line3"><!-- --></div><div class="line2"><!-- --></div><div class="line1"><!-- --></div>');
                        prompt.append(arrow);
                        break;
                }
            }
            //<div class="line10"><!-- --></div><div class="line9"><!-- --></div><div class="line8"><!-- --></div><div class="line7"><!-- --></div><div class="line6"><!-- --></div>
            //<div class="line6"><!-- --></div><div class="line7"><!-- --></div><div class="line8"><!-- --></div><div class="line9"><!-- --></div><div class="line10"><!-- --></div>
            if (options.relative) {
            ...
            var promptLeft = parseInt(pos.callerleftPosition);
            var promptWidth = prompt.offset().left + promptLeft;
            if (windowWidth < promptWidth) {
                //debugger;
                pos.callerleftPosition = (promptLeft - (prompt.outerWidth() / 2) - 10) + "px";
            }
            ...
            if (!methods.isRTL(field)) {
                switch (positionType) {
                    ...
                    case "bottomLeft":
                        ...
                        promptTopPosition = promptTopPosition + field.height() + field.offset().top + 25;
                        break;
                    case "bottomRight":
                        promptleftPosition += fieldWidth - 30;
