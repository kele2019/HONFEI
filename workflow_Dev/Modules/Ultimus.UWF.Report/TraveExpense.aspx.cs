...
{
	public partial class TraveExpense : System.Web.UI.Page
	{
		...
		public void LoadDataInfo()
		{
			try
			{
				...
				string sql = "select * from dbo.PROC_TravelExpense where status = '2' and APPLICANTACCOUNT='" + Page.User.Identity.Name.Replace("\\","/") + "' ";
