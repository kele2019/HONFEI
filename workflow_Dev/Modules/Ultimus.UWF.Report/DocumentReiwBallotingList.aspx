<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentReiwBallotingList.aspx.cs" Inherits="Ultimus.UWF.Report.DocumentReiwBallotingList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function documentno_click(obj) {
            ...
            var url = "./DocumentReviewBallotingForm.aspx?FormID='" + suburl + "'"
        ...
        <div>
            <table class="table table-condensed table-bordered">
                <thead>
                    <tr>
                        <th width="4%">NO.</th>
                        <th width="25%">DocumentNO</th>
                        <th  style="display:none;"></th>
                        <th width="25%">DocumentName</th>
                        <th width="25%">DocumentOwner</th>
                        <th >Date</th>
                    </tr>
                </thead>
                    ...
                    <asp:Repeater runat="server" ID="travelExpenseReport">
                         <ItemTemplate>
                            <tr>
                                ...
                                <td><a class="documentno" onclick="documentno_click(this)" style="cursor:pointer"><p style="text-align:center"><%# Eval("DOCUMENTNO")%></p></a></td>
                                <td style="display:none;"><asp:Label runat="server" ID="FORMID" Text='<%# Eval("FORMID")%>'></asp:Label></td>
                                <td><%#Eval("documentName")%></td>
                                <td><%#Eval("documentOwner")%></td>
