<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TraveExpense.aspx.cs" Inherits="Ultimus.UWF.Report.TraveExpense" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
            function documentno_click(obj) {
                ...
                var url = "./TravelExpenseReport.aspx?FormID='" + suburl + "'"
