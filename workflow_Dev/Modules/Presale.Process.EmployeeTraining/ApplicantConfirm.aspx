<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplicantConfirm.aspx.cs" Inherits="Presale.Process.EmployeeTraining.ApplicantConfirm" %>
            ...
            <div class="row">
                ...
                <table id="papersTable" class="table table-condensed table-bordered">
                 ...
                 <table id="Table1" class="table table-condensed table-bordered">
                    <tr>
                    <td class="td-label" style="text-align:center">Training personnel</td>
                   <td class="td-content" colspan="7" >
                <ul id="menu">
                ...
                <li>
                 ...
                 <asp:CheckBox ID="User3" class="user" Checked='<%#Eval("SumDate").ToString()=="0"? false:true %>' Text=''   runat="server" />
