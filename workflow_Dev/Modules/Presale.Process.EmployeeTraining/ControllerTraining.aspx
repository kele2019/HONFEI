<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ControllerTraining.aspx.cs" Inherits="Presale.Process.EmployeeTraining.ControllerTraining" %>
            ...
            <div class="row">
                ...
                <%--<table class="table table-condensed table-bordered">
                    <tr>
                        <td class="td-label">
                         <span style="height:30px; float:left;">&nbsp;</span>
                        <p style="text-align:center;">Training document</p>
                        </td>
                        <td class="td-content" colspan="7" >
                ...
                <tr>
                    <td align="center"  >
                        <table>
                            <tr>
                                <td> 
                                <input type="button" id="btnComplete" class="btn" value="Close Training" onclick="submitPageReview('0')" />
                                </td>
                            </tr>
                       </table>
                    </td>
