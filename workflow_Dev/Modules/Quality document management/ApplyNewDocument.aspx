<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplyNewDocument.aspx.cs" Inherits="Ultimus.UWF.FunctionManager.Quality_document_management.ApplyNewDocument" %>
...
<body>
    ...
    <tr>
    <td colspan="4"  style="text-align: left;">Add Document（<span style=" background:red">&nbsp;</span> must write）
    </td>
    </tr>
    <tr><td class="td-label">
     <span style=" background:red;float:left;">&nbsp;</span> 
    <p style="text-align:center">Select document</p></td><td></td>
    <td colspan="3"> <attach:attachments id="Attachments1" runat="server"></attach:attachments></td>
    </tr>
        </table>
