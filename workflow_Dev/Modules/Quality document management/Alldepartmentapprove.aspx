<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Alldepartmentapprove.aspx.cs" Inherits="Ultimus.UWF.FunctionManager.Quality_document_management.Alldepartmentapprove" %>
...
<body>
    ...
    <tr>
     <td class="td-label"><p style="text-align:center">Browse Document</p></td>
    </tr>
    <tr>
    <td class="td-label" >Select document</td>
     <td colspan="3">
 ...
 <asp:TextBox ID="read_selectdocument" runat="server" Text='<%#Eval("selectdocument") %>' Style="display: none"></asp:TextBox>
        <asp:Button ID="ButDown" CssClass="btn validate-skip"  runat="server" Text="Down" />
    </td>
    </tr>
    </table>
    <div class="row">
