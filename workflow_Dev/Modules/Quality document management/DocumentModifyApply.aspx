<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentModifyApply.aspx.cs" Inherits="Ultimus.UWF.FunctionManager.Quality_document_management.NewRequest" %>
...
<body> 
 ...
 <asp:TextBox ID="fld_OperMode" runat="server" Text='<%#Eval("OperMode") %>' Style="display: none"></asp:TextBox>
    ...
    <tr>
      <td class="td-label">
      <span style=" background:red;float:left;">&nbsp;</span> 
    <p style="text-align:center">Select document</p></td>
    <td colspan="3">
        <asp:DropDownList ID="DropDOC" runat="server" Width="80%" onchange="changetype(this)">
        </asp:DropDownList>
 <asp:TextBox ID="fld_selectdocument" runat="server" Text='<%#Eval("selectdocument") %>' Style="display: none"></asp:TextBox>
    </td>
    </tr>
    <tr>
     <td class="td-label">
    ...
    <span style=" background:red; float:left">&nbsp;</span> 
    <p style="text-align:center">major change</p> </td>
    <td colspan="3">
     <asp:TextBox ID="fld_majorchange" runat="server" Width="80%"  TextMode="MultiLine" Height="50px" CssClass="validate[required]" ></asp:TextBox>
    </td>
    </tr>
        </table>
        <table class="table table-condensed table-bordered" >
    ...
    <tbody id="tabletbodyDetail">
     <asp:Repeater ID="Repeaterlist" runat="server" >
        <ItemTemplate>
        <tr>
        <td><asp:CheckBox ID="CheckBox1" runat="server" Text='<%# Eval("USER1") %>' /></td>
         <td><asp:CheckBox ID="CheckBox2" runat="server" Text='<%# Eval("USER2") %>' /></td>
          <td><asp:CheckBox ID="CheckBox3" runat="server" Text='<%# Eval("USER2") %>'  /></td>
        </tr>
        </ItemTemplate>
        </asp:Repeater>
        </tbody>
