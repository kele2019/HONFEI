...
namespace Presale.Process.PurchaseOrder
{
	public partial class Purchase : System.Web.UI.Page
	{
		...
		public void repeaterbind()
		{
			...
			string sql = "select * from ( select DOCUMENTNO,APPLICANT,DEPARTMENT,CostCenterDisplay,CostCenterCode,PriceTerms,Currency,Remarks,Date,TotalAmount,APPLICANTACCOUNT FROM PROC_Purchase where status='2' and PurchaseOrdStatus = 0) B";
