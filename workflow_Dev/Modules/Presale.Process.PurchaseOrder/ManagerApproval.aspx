<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagerApproval.aspx.cs" Inherits="Presale.Process.PurchaseOrder.ManagerApproval" %>
                    ...
                    <asp:Repeater runat="server" ID="fld_detail_PROC_PurchaseOrder_DT" OnItemDataBound="fld_detail_PROC_PurchaseOrder_DT_ItemDataBound">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="read_UNIT" runat="server" Text='<%#Eval("UNIT") %>' Width="84%"></asp:Label>
                                </td>
                                <td>
                                  ...
                                  <td>
                                   <asp:Label ID="read_CostCenter" runat="server" Text='<%#Eval("CostCenter") %>' style="display:none;"></asp:Label>
                                    <asp:Label ID="read_COSTCENTERDISPLAY" runat="server" Text='<%#Eval("COSTCENTERDISPLAY") %>'></asp:Label>
                                </td>
                                  <td>
                                   <asp:Label ID="read_Project" runat="server" Text='<%#Eval("Project") %>' style="display:none;"></asp:Label>
                                    <asp:Label ID="read_ProjectDisplay" runat="server" Text='<%#Eval("ProjectDisplay") %>'></asp:Label>
                                </td>
                            </tr>
