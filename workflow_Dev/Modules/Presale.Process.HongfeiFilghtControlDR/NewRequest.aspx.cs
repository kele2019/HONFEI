	...
	public partial class NewRequest1 : System.Web.UI.Page
	{
		protected void Page_Load(object sender, EventArgs e)
		{
			if (!IsPostBack)
			{
				...
				{
					string FlagStatus = DataAccess.Instance("BizDB").ExecuteScalar("select  status from PROC_ITRecovery where INCIDENT='" + Incident + "' ").ToString();
				...
				fld_DepartmentManager.Text = departmentManager.EXT02.Replace("\\", "/") + "|USER";
			}
