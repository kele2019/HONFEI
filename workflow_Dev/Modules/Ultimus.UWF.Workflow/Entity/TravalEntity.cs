...
namespace Ultimus.UWF.Workflow.Entity
{
    public   class TravalEntity
    {
        ...
        public TravalEntity()
        { }
        public TravalEntity(string fORMID, string pROCESSNAME, int? iNCIDENT, string dOCUMENTNO, string aPPLICANT, string aPPLICANTCODE, string aPPLICANTACCOUNT, string rEGION, string lOCATION, string bUCODE, string bUSSINESSNUIT, string cOSTCENTER, DateTime? rEQUESTDATE, string dEPARTMENT, string cOMPANYCODE, string cOMPANY, string pROCESSSUMMARY, string sTATUS, string tRSummary, DateTime? travelStartDate, string travelCity, string travaelPurpose, string travalComments, string departmentCode, string travalType, string travalCount, string yDNo, string jDNo, string jPYDYes, string jPYDNo, string yDJDYes, string yDJDNo, string yWXY, string pX, string qT, string yDComments, string yDJDComments, List<MyDB> travalDeatil, List<Presale.Process.Common.ApprovalHistoryEntity> approvalhistory, List<Presale.Process.Common.AttachmentEntity> attachment)
        {
            this.FORMID = fORMID;
