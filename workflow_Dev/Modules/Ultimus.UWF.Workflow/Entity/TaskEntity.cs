...
namespace Ultimus.UWF.Workflow.Entity
{
    public class TaskEntity : IComparable
    {
        ...
        public string FORMURL
        {
            get {
                if (string.IsNullOrEmpty(_FORMURL))
                {
                    ...
                    _FORMURL = ConfigurationManager.AppSettings["RequestURL"] + "/Modules/Ultimus.UWF.Workflow/OpenForm.aspx?taskid=" + TASKID + "&ServerName=" + SERVERNAME;
                }
                return _FORMURL; }
            set { _FORMURL = value; }
        }
		...
		string _RequestorDate;
		public string RequestorDate
		{
			get { return _RequestorDate; }
            set { _RequestorDate = value; }
		}
    ...
    public partial class TravalEntity1
    {
        public TravalEntity1()
        { }
        ...
        public int CompareTo(object obj)
        {
            TravalEntity1 pe = obj as TravalEntity1;
            return string.Compare(this.FORMID, pe.FORMID);
        }
    }
