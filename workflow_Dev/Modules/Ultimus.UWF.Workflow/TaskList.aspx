<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskList.aspx.cs" Inherits="Ultimus.UWF.Workflow.TaskList" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function Callback() {
            return window.confirm('您确定要撤回流程吗?');
        }
    ...
    <div id="right">
        ...
        <div id="tabBtn1">
            <ul>
                <li id="reorder1" class='selectLi1' style="height: 39px; line-height: 39px; margin-top: 0;">
                    <p>
                        <img src="images/reorder1Sel.png" />
                        <a href='<%=GetSortUrl("a.STARTTIME DESC") %>'>
                            <%=Lang.Get("TaskList_Default")  %></a></p>
                </li>
                <li id="reorder2" class='normalLi1' style="color: #626262; height: 25px; line-height: 25px;
                    margin-top: 7;">
                    <p>
                        <img src="images/reorder2.png" />
                        <a href='<%=GetSortUrl("a.STARTTIME DESC") %>' style="color: #626262;" class='<%=GetSortCurCss("a.STARTTIME DESC") %>'>
                            <%=Lang.Get("TaskList_StartTime")  %></a></p>
                </li>
                <li id="reorder3" class='normalLi1' style="color: #626262; height: 25px; line-height: 25px;
                    margin-top: 7;">
                    <p>
                        <img src="images/reorder3.png" />
                        <a href='<%=GetSortUrl("a.PROCESSNAME") %>' style="color: #626262;" class='<%=GetSortCurCss("a.PROCESSNAME") %>'>
                            <%=Lang.Get("TaskList_ProcessName")  %></a></p>
                </li>
                <li id="reorder4" class='normalLi1' style="color: #626262; height: 25px; line-height: 25px;
                    margin-top: 7;">
                    <p>
                        <img src="images/reorder4.png" />
                        <a href='<%=GetSortUrl("b.STATUS") %>' style="color: #626262;" class='<%=GetSortCurCss("b.STATUS") %>'>
                            <%=Lang.Get("TaskList_Status") %></a></p>
                </li>
                <li id="Li1" class='normalLi1 searchli' style="color: #626262; height: 25px; line-height: 25px;
                    margin-top: 7;float:right;">
                    <p>
                        <img src="images/open.png" />
                       <a href="#" onclick="toogleSearch();"  style="color: #626262;"> <%=Lang.Get("TaskList_AdvSearch")%></a>
                    </p>
        ...
        <div id="divQuery" class="hide">
            <table cellpadding="5">
                ...
                <tr>
                    <td>
                        <asp:Label ID="lbQstep" runat="server" Text="步骤名称" CssClass="lbl"></asp:Label><asp:Label
                            ID="lblApplicant" runat="server" Text="申请人" CssClass="lbl" Visible="false"></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtStepName" runat="server" CssClass="input-query"></asp:TextBox><asp:TextBox
                            ID="txtApplicant" CssClass="input-query" runat="server" Visible="false"></asp:TextBox>
                    </td>
                    <td>
        ...
        <table id="tab" class="tab" width="100%" border="0" cellpadding="5" cellspacing="0">
            <thead>
                <tr>
                    <th>
                        <input type="checkbox" id="allCheck" onchange="changeStatus(this)" />
                    </th>
                    <th>
                            ...
                            <div id="pageLeft">
                                ...
                                <asp:Button ID="btnAbort" runat="server" CssClass="btn" Visible="false" Text="作废"
                                    OnClick="btnAbort_Click" OnClientClick="return Abort();" />
                                      <asp:Button ID="btnCallback" runat="server" CssClass="btn" 
                                    Visible="false" Text="撤回"
                                     OnClientClick="return Callback();" onclick="btnCallback_Click" />
                            </div>
                            <div id="pageRight">
