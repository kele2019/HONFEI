<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyTaskList.aspx.cs" Inherits="Ultimus.UWF.Workflow.View.Maintenanc.MyTaskList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ajaxGetTaskList() {
            var pmt = { 'Method': 'MyTask', 'ProcessName': $("#ProcessName").val(), 'Incident': $("#Incident").val(),
        ...
        function addTaskListRow(data, rowIndex) {
            ...
            html += "<td>" + data.ISTARTTIME + "</td>";
            html += "<td>" + data.IENDTIME + "</td>";
            html += "</tr>";
