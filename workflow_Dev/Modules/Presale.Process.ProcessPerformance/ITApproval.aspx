<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ITApproval.aspx.cs" Inherits="Presale.Process.ProcessPerformance.ITApproval" %>
                ...
                <table class="table table-condensed table-bordered">
                    ...
                    <tr>
                       ...
                       <span style="background:red;margin-top:5px;  height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="3" >
                            <asp:TextBox runat="server" ID="fld_ITStatus1" Width="96%" CssClass="validate[required]"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                       ...
                       <span style="height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="7" >
                            <asp:TextBox runat="server" ID="fld_ITActionNeed1" TextMode="MultiLine" Rows="3" Width="98%"></asp:TextBox>
                        </td>
                    </tr>
                </table>
                <table class="table table-condensed table-bordered">
                    ...
                    <tr>
                       ...
                       <span style="background:red;margin-top:5px;  height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="3" >
                            <asp:TextBox runat="server" ID="fld_ITStatus2" Width="96%" CssClass="validate[required]"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="td-label" style="vertical-align:middle;"> 
                       <span style="height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="7" >
                            <asp:TextBox runat="server" ID="fld_ITActionNeed2" TextMode="MultiLine" Rows="3" Width="98%"></asp:TextBox>
                        </td>
                    </tr>
                </table>
                <table class="table table-condensed table-bordered">
                    ...
                    <tr>
                       ...
                       <span style="background:red;margin-top:5px;  height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="3" >
                            <asp:TextBox runat="server" ID="fld_ITStatus3" Width="96%" CssClass="validate[required]"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="td-label" style="vertical-align:middle;"> 
                       <span style="height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="7" >
                            <asp:TextBox runat="server" ID="fld_ITActionNeed3" TextMode="MultiLine" Rows="3" Width="98%"></asp:TextBox>
                        </td>
                    </tr>
                </table>
            </div>
