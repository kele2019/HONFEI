<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminApproval.aspx.cs" Inherits="Presale.Process.ProcessPerformance.AdminApproval" %>
                ...
                <table class="table table-condensed table-bordered">
                    ...
                    <tr>
                       ...
                       <span style="background:red;margin-top:5px;  height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="3" >
                            <asp:TextBox runat="server" ID="fld_AdminStatus" Width="96%" CssClass="validate[required]"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="td-label"> 
                       <span style="height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="7" >
                            <asp:TextBox runat="server" ID="fld_AdminActionNeed" TextMode="MultiLine" Rows="3" Width="98%"></asp:TextBox>
                        </td>
                    </tr>
                </table>
            </div>
