...
{
	public partial class SupplyChainApproval : System.Web.UI.Page
	{
		protected void Page_Load(object sender, EventArgs e)
		{
			if (!IsPostBack)
			{
				string sql1 = "select DicCode,DicText,DicValue,Comments from COM_DICTIONRY where Type = 'HFPD-03' and Comments = '1'";
				string sql2 = "select DicCode,DicText,DicValue,Comments from COM_DICTIONRY where Type = 'HFPD-03' and Comments = '2'";
				...
				string sql3 = "select DicCode,DicText,DicValue,Comments from COM_DICTIONRY where Type = 'HFPD-03' and Comments = '3'";
