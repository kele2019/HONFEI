<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagementApproval.aspx.cs" Inherits="Presale.Process.ProcessPerformance.ManagementApproval" %>
                ...
                <table class="table table-condensed table-bordered">
                    ...
                    <tr>
                       ...
                       <span style="background:red;margin-top:5px;  height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="3" >
                            <asp:TextBox runat="server" ID="fld_ManagementStatus" Width="96%" CssClass="validate[required]"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                       ...
                       <span style="height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="7" >
                            <asp:TextBox runat="server" ID="fld_ManagementActionNeed" Rows="3" Width="98%" TextMode="MultiLine"></asp:TextBox>
                        </td>
                    </tr>
                </table>
            </div>
