<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HRApproval.aspx.cs" Inherits="Presale.Process.ProcessPerformance.HRApproval" %>
                ...
                <table class="table table-condensed table-bordered">
                    ...
                    <tr>
                       ...
                       <span style="background:red;margin-top:5px;  height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="3" >
                            <asp:TextBox runat="server" ID="fld_HRStatus1" Width="96%" CssClass="validate[required]"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                       ...
                       <span style="height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="7" >
                            <asp:TextBox runat="server" ID="fld_HRActionNeed1" TextMode="MultiLine" Rows="3" Width="98%"></asp:TextBox>
                        </td>
                    </tr>
                </table>
                <table class="table table-condensed table-bordered">
                    ...
                    <tr>
                       ...
                       <span style="background:red;margin-top:5px;  height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="3" >
                            <asp:TextBox runat="server" ID="fld_HRStatus2" Width="96%" CssClass="validate[required]"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="td-label" style="vertical-align:middle;"> 
                       <span style="height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="7" >
                            <asp:TextBox runat="server" ID="fld_HRActionNeed2" TextMode="MultiLine" Rows="3" Width="98%"></asp:TextBox>
                        </td>
                    </tr>
                </table>
                <table class="table table-condensed table-bordered">
                    ...
                    <tr>
                       ...
                       <span style="background:red;margin-top:5px;  height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="3" >
                            <asp:TextBox runat="server" ID="fld_HRStatus3" Width="96%" CssClass="validate[required]"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="td-label" style="vertical-align:middle;"> 
                       <span style="height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="7" >
                            <asp:TextBox runat="server" ID="fld_HRActionNeed3" TextMode="MultiLine"  Rows="3" Width="98%"></asp:TextBox>
                        </td>
                    </tr>
                </table>
            </div>
