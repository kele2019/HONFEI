<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplyChainApproval.aspx.cs" Inherits="Presale.Process.ProcessPerformance.SupplyChainApproval" %>
                ...
                <table class="table table-condensed table-bordered">
                    <tr>
                       ...
                       <span style="margin-top:5px;  height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="3" >
                            <asp:Label runat="server" ID="Process1"></asp:Label>
                        </td>
                        <td class="td-label"> 
                       <span style="margin-top:5px;  height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="3" >
                            <asp:Label runat="server" ID="Measurement1"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="td-label"> 
                       <span style="margin-top:5px;  height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="3" >
                            <asp:Label runat="server" ID="Standard1"></asp:Label>
                        </td>
                        <td class="td-label"> 
                       <span style="background:red;margin-top:5px;  height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="3" >
                            <asp:TextBox runat="server" ID="fld_SupplyChainStatus1" Width="96%" CssClass="validate[required]"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                       ...
                       <span style="height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="7" >
                            <asp:TextBox runat="server" ID="fld_SupplyChainActionNeed1" Rows="3" Width="98%" TextMode="MultiLine"></asp:TextBox>
                        </td>
                    </tr>
                </table>
                <table class="table table-condensed table-bordered">
                    ...
                    <tr>
                       ...
                       <span style="background:red;margin-top:5px;  height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="3" >
                            <asp:TextBox runat="server" ID="fld_SupplyChainStatus2" Width="96%" CssClass="validate[required]"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="td-label" style="vertical-align:middle;"> 
                       <span style="height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="7" >
                            <asp:TextBox runat="server" ID="fld_SupplyChainActionNeed2" Rows="3" Width="98%" TextMode="MultiLine"></asp:TextBox>
                        </td>
                    </tr>
                </table>
                <table class="table table-condensed table-bordered">
                    ...
                    <tr>
                       ...
                       <span style="background:red;margin-top:5px;  height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="3" >
                            <asp:TextBox runat="server" ID="fld_SupplyChainStatus3" Width="96%" CssClass="validate[required]"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="td-label" style="vertical-align:middle;"> 
                       <span style="height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="7" >
                            <asp:TextBox runat="server" ID="fld_SupplyChainActionNeed3" Rows="3" Width="98%" TextMode="MultiLine"></asp:TextBox>
                        </td>
                    </tr>
                </table>
            </div>
