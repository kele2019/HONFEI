<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplierNewOrModifyDocument.aspx.cs" Inherits="Presale.Process.QualityDocumentManagement.ApplierNewDocument" %>
            ...
            <table class="table table-condensed table-bordered">
                <tr>
                    ...
                    <td>
                        ...
                        <input type="button" runat="server" value="Browse" onclick="downLoad_Click(this)"/>
                    </td>
                </tr>
            </table>--%>
            <table class="table table-condensed table-bordered">
                <tr>
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="MultiLine" Rows="3" ID="fld_FollowUPAction" Width="98%"></asp:TextBox>
                    </td>
                </tr>
            </table>
            </div>
