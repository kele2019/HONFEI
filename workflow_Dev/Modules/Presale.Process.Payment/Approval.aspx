<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Approval.aspx.cs" Inherits="Presale.Process.Payment.Approval" %>
...
//            alert("test");
//            alert($("#fld_ApplicantUserPost").val());
//            return true;
        //        }
...
<body>
    <form id="form1" runat="server">
     <div id="myDiv" class="container">
            ...
            <asp:TextBox runat="server" ID="fld_ApplicantUserPost" style="display:none;"></asp:TextBox>
            <div class="row">
