<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Vendor.aspx.cs" Inherits="Presale.Process.Payment.Vendor" %>
            ...
            <asp:Repeater runat="server" ID="EmployeeList">
                <ItemTemplate>
                    <tr>
                        ...
                        <%--<td style="text-align:center">
                            <asp:Label runat="server" ID="BankCode" Text='<%#Eval("BankCode") %>'></asp:Label>
                        </td>--%>
                        <td style="text-align:center">
