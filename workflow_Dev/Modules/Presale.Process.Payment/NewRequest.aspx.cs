	...
	public partial class NewRequest : System.Web.UI.Page
	{
		protected void Page_Load(object sender, EventArgs e)
		{
			if (!IsPostBack)
			{
				...
				{
					string FlagStatus = DataAccess.Instance("BizDB").ExecuteScalar("select  status from PROC_Payment where INCIDENT='" + Incident + "' ").ToString();
		...
		//{
		//    string strSql = "select DicText,DicValue from dbo.COM_DICTIONRY where type='downpayment'";
		//    DataTable dtFinaInfo = DataAccess.Instance("BizDB").ExecuteDataTable(strSql);

		//    dropVendorName.DataTextField = "DicText";
		//    dropVendorName.DataValueField = "DicValue";
		//    dropVendorName.DataSource = dtFinaInfo;
		//    dropVendorName.DataBind();
		//}

		//protected void onVendorNameChange(object sender, EventArgs e)
		//{
		//    string value = dropVendorName.Text;
		//    string sql = "select VendorCode,PONO,BankAccount,CostCenterNumber,DownpaymentAmount from dbo.PROC_DownPayentSecond where VendorName='" + value + "'";
		//    Vendor vendor = DataAccess.Instance("BizDB").ExecuteEntity<Vendor>(sql);
		//    fld_VendorCode.Text = vendor.VendorCode;
		//    fld_BankAccount.Text = vendor.BankAccount;
		//    fld_PONO.Text = vendor.PONO;
		//    fld_CostCenterNumber.Text = vendor.CostCenterNumber;
		//    fld_DownpaymentAmount.Text = vendor.DownpaymentAmount;
		//}
	}
}