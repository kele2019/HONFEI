<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinanceApproval.aspx.cs" Inherits="Presale.Process.PurchaseApplication.FinanceApproval" %>
            ...
            <div class="row">
                ...
                <table class="table table-condensed table-bordered">
                    <tr>
                        ...
                        <%--<th width="11%"><p style="text-align:center">Items</p></th>--%>
                        <th width="11%"><p style="text-align:center">Material Description</p></th>
                        <th width="11%"><p style="text-align:center">Specification</p></th>
                        <th width="11%"><p style="text-align:center">Vendor</p></th>
                        <th width="11%"><p style="text-align:center">Request Date</p></th>
                        <th width="11%"><p style="text-align:center">Lead Time</p></th>
                        <th width="11%"><p style="text-align:center">Unit Price</p></th>
                        <th width="11%"><p style="text-align:center">Unit</p></th>
                        <th width="11%"><p style="text-align:center">Qty.</p></th>
                        <th width="11%"><p style="text-align:center">Amount</p></th>
                    </tr>
