<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectUserNew.aspx.cs"
    Inherits="Ultimus.UWF.OrgChart.SelectUserNew" %>
...
<body style="overflow-x: hidden; overflow-y: hidden;">
    ...
    <div>
        <div style="float: left; width: 240px; margin-left: 5px; margin-top: 5px; height: 400px;
            overflow: scroll;">
            <asp:TreeView ID="UserTreeView" runat="server" OnSelectedNodeChanged="UserTreeView_SelectedNodeChanged"  onclick="client_OnTreeNodeChecked()"
        ...
        <div style="float: left; width: 545px; height: 400px;">
            <div class="pt10 pb10 pr10" style="margin-left: 5px; margin-bottom: 5px; margin-top: 5px;">
                <asp:TextBox ID="txtSearch" runat="server" Width="460px"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button
                    ID="btnSearch" runat="server" Text="查询" CssClass="btn btn-primary" OnClick="btnSearch_Click" /></div>
            <div style="overflow-x: hidden; overflow-y: scroll; height: 180px; margin-left: 5px;"
                id="divUser" runat="server">
            ...
            <div style="overflow: hidden; height: 30px; width: 545px; margin-left: 5px;">
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:Button ID="Button2" Text="取消" runat="server" CssClass="btn" OnClientClick="return Cancel()"
                                OnClick="Button2_Click" Height="25" Visible="false" />
                            <script type="text/javascript" language="javascript">
                                function Cancel() {
                                    var isok = false;
                            ...
                            <%--<div class="right">
                                <asp:Button ID="btnOK" runat="server" Text="确 定" OnClick="btnOK_Click" CssClass="btn btn-primary "
                                    Style="height: 25px; margin-right:5px" OnClientClick="return SinglePersonConfirm('');" />
                                <input type="button" value="关闭" class="btn" onclick="CloseForm()" style="height: 25px; margin-right:5px" />
                                </div>--%>
                            <script type="text/javascript" language="javascript">
            ...
            <div id="SelectedList" runat="server" visible="false" style="overflow: hidden; height: 150px;
                margin-left: 5px;">
