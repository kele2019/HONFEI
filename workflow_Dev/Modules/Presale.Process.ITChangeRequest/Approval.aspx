<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Approval.aspx.cs" Inherits="Presale.Process.ITChangeRequest.Approval" %>
            ...
            <div class="row">
                ...
                <table class="table table-condensed table-bordered">
                    ...
                    <table class="table table-condensed table-bordered">
                        ...
                        <td class="td-content" colspan="7" >
                            <asp:CheckBox ID="SeverityImpact1" runat="server" value="High" disabled="true" />High &nbsp;&nbsp;
                            <asp:CheckBox ID="SeverityImpact2" runat="server" value="Medium" disabled="true" />Medium &nbsp;&nbsp;
                            <asp:CheckBox ID="SeverityImpact3" runat="server" value="Low" disabled="true" />Low
                            <asp:Label runat="server" ID="read_SeverityImpact" style="display:none;"></asp:Label>
                        </td>
                    </tr>
                    </table>
