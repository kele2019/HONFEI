<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartmentManagerApproval.aspx.cs" Inherits="Presale.Process.ITChangeRequest.DepartmentManagerApproval" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if ($("#fld_Severead_SeverityImpactrityImpact").text() == "Medium") {
                $("#radioButton1").attr("checked", true);
            }
            if ($("#read_SeverityImpact").text() == "Low") {
                $("#radioButton2").attr("checked", true);
            }
            if ($("#read_DepartmentManager").text() == $("#read_DGM").text()) {
                $("#sectionThird").show();
            }
            if ($("#read_ITAdmin").text() == $("#read_ITM").text()) {
                $("#sectionThird").show();
            }
            if ($("#read_DepartmentManager").text() == $("#read_ITM").text()) {
                $("#section3").show();
            }
            if ($("#hdIncident").val() != "") {
            ...
            $("#fld_ITTeamNeed").val($("#read_ITTeamNeed").text());
        });
    </script>
</head>
<body>
    <form id="form1" runat="server">
     <div id="myDiv" class="container">
            <div class="row">
                ...
                <asp:Label runat="server" ID="read_DepartmentManager" style="display:none;"></asp:Label>
                <asp:Label runat="server" ID="read_ITAdmin" style="display:none;"></asp:Label>
                <asp:Label runat="server" ID="read_ITM" style="display:none;"></asp:Label>
                <asp:Label runat="server" ID="read_DGM" style="display:none;"></asp:Label>
            </div>
            <div class="row">
                ...
                <table class="table table-condensed table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="td-content" colspan="7" >
                            <asp:CheckBox ID="radioButton0" runat="server" disabled="disabled"/>High &nbsp;&nbsp;
                            <asp:CheckBox ID="radioButton1" runat="server" disabled="disabled"/>Medium &nbsp;&nbsp;
                            <asp:CheckBox ID="radioButton2" runat="server" disabled="disabled"/>Low
                        </td>
                    ...
                    <div style="display:none;" id="sectionThird">
