<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HRApprove.aspx.cs" Inherits="Presale.Process.ProbationEvaluation.HRApprove" %>
 ...
 <meta http-equiv="X-UA-Compatible"  content="IE=EmulateIE8" />
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var HRResultValue = $("#read_HRResultValue").val();
            if (HRResultValue != "")
                $("input[name^='HRResultValue']").eq((HRResultValue - 3) * (-1)).attr("checked", true);
        ...
        <div class="row">
            <ui:userinfo id="UserInfo1" processtitle="Employee Probation Assessment Form" processprefix="EP" tablename="PROC_ProbationEvaluation"
              ...
              Demonstrates high capability to think and act effectively.Originates new ideas or methods to improve the job or to complete assigned tasks with high standard
                ...
                <tr>
                <td colspan="3">
                <input type="radio" name="HRResultValue"   onclick="CheckedValue('HRResultValue','3')"/>Completed &nbsp; &nbsp;&nbsp;
                  <input type="radio"  name="HRResultValue"   onclick="CheckedValue('HRResultValue','2')" />Extended
                  <asp:TextBox runat="server" ID="fld_HRExtendMonth" Width="50px"></asp:TextBox>
                   <asp:TextBox runat="server" ID="fld_HRResultValue" Width="50px" style="display:none"></asp:TextBox>
                  Month  &nbsp; &nbsp;&nbsp;
                  <input type="radio"  name="HRResultValue"   onclick="CheckedValue('HRResultValue','1')" />Unsatisfied, Dismissal
                  </td>
                </tr>
                </table>
                </div>
