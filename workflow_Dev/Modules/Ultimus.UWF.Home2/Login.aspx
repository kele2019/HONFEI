<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Ultimus.UWF.Home2.Login" %>
...
<body id="bodyy">
    ...
    <div id="loginbg" class="loginbg">
        <div class="loginfont">
          <%--  <%=Lang.Get("Login_ProjectTitle")%>--%>
          HonFei BPM System</div>
        <div>
        ...
        <div >
            <asp:DropDownList ID="ddlDomains"  Visible="false" class="txt3" runat="server">
            </asp:DropDownList>
        </div>
        <div class="rempwd">
            <div class="rempwd_l">
        ...
        <div>
       <img style="margin-left:100px; margin-top:8px; height:59.24px;width:160px;" alt="logo" src="login_images/logo.png" />
        </div>
    </div>
    <!--[if gte IE 6]>
    <script type="text/javascript">  
