...
namespace Ultimus.UWF.Home2
{
    public partial class ToDoList : BasePage
    {
		...
		//protected string StepName { get { return ddlStep.SelectedItem.Value; } }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                BindData();
				hiddraftcount.Value=GetDraftcount().ToString();
            }
        }
		...
		{
       return  Convert.ToInt32(DataAccess.Instance("BizDB").ExecuteScalar("select count(1) from WF_DRAFT where createby='" + UserID + "'").ToString());
		}
