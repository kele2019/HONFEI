        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Incident.ToString() != "0")
                {
                    ...
                    string FlagStatus = DataAccess.Instance("BizDB").ExecuteScalar("select  status from PROC_HeadCount where INCIDENT='" + Incident + "' ").ToString();
                ...
                fld_CostCenterInfo.DataTextField = "CodeDesc";
                fld_CostCenterInfo.DataValueField = "CostCenter";
                fld_CostCenterInfo.DataSource = Bll.GetCostCenter();
                fld_CostCenterInfo.DataBind();
                fld_CostCenterText.Text = fld_CostCenterInfo.SelectedItem.Text;
