            ...
            <asp:Repeater ID="Repeater1" runat="server" onitemdatabound="Repeater1_ItemDataBound">
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="dropTableName" runat="server"  AutoPostBack="true" onselectedindexchanged="dropTableName_SelectedIndexChanged">
                            </asp:DropDownList>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:DropDownList ID="dropVariableName" runat="server" CssClass="input-xlarge"  >
                            </asp:DropDownList>
                        </td>
                    </tr>
                </ItemTemplate>
