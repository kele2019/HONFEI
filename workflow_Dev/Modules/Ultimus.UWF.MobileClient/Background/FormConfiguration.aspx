        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    ...
                    <th style="display:none;"><%= Resources.Resource.FormConfiguration_List_IsShow %></th>
                    ...
                    <ItemTemplate>
                        <tr style="text-align:center;">
                            ...
                            <td style="display:none;">
                                ...
                                <asp:CheckBox ID="ItemIsShow" runat="server" CssClas="checkbox"/>
                                <asp:HiddenField runat="server" ID="ItemhfIsShow" Value='<%# Eval("IsShow") %>'/>
                            </td>
                            <td>
