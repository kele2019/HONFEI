    ...
    public partial class FormConfiguration : BasePage.BasePageClass
    {
        ...
        private void BingData()
        {
            try
            {
                ...
                if (StepListEntity.Count > 0)
                {
                    ...
                    List<EntityLibrary.MobileClient_StepControl> StepControlList = StepControldal.GetModel("FK_ID='" + StepEntity.ID + "' order by Convert(int,isnull(orderby,0))");
        ...
        protected void Repeater1_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            try
            {
                ...
                HiddenField isWillFill_HF = e.Item.FindControl("ItemhfIsWillFill") as HiddenField;
                CheckBox isWillFill_CB = e.Item.FindControl("ItemIsWillFill") as CheckBox;
                if (isWillFill_HF.Value.ToUpper() == "TRUE") 
                {
                    isWillFill_CB.Checked = true;
                }

                HiddenField isReadOnly_HF = e.Item.FindControl("ItemhfReadOnly") as HiddenField;
                CheckBox isReadOnly_CB = e.Item.FindControl("ItemReadOnly") as CheckBox;
                if (isReadOnly_HF.Value.ToUpper() == "TRUE")
                {
                    isReadOnly_CB.Checked = true;
                }

                HiddenField isShow_HF = e.Item.FindControl("ItemhfIsShow") as HiddenField;
                CheckBox isShow_CB = e.Item.FindControl("ItemIsShow") as CheckBox;
                if (isShow_HF.Value.ToUpper() == "TRUE")
                {
                    isShow_CB.Checked = true;
                }
            }
            catch (Exception ex)
            {
        ...
        private void SavePageData()
        {
            ...
            foreach (RepeaterItem item in Repeater1.Items)
            {
                ...
                model.IsShow = (item.FindControl("ItemIsShow") as CheckBox).Checked.ToString();
