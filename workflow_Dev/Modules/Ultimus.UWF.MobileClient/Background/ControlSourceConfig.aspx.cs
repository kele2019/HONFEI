...
namespace MobileClientBackground
{
    public partial class ControlSourceConfig : BasePage.BasePageClass
    {
        ...
        private void BingData()
        {
            try
            {
                ...
                if (list.Count > 0)
                {
                    ...
                    ////List<VarEntity> Variables =
                    //dropVariableName.DataSource = _ref.GetVariableList(ProcessName, "");
        ...
        private void BingElectronicFormData()
        {
            ...
            //VarEntity[] Variables = _ref.GetVariableList("", ProcessName);
            //List<VarEntity> Variables = ;
            dropVariableName.DataSource = ReturnIniXML(ProcessName, StepName);//.GetVariableList(ProcessName, "");
            //dropVariableName.DataTextField = "Name";
            //dropVariableName.DataValueField = "Name";
            dropVariableName.DataBind();
        ...
        protected string[] ReturnIniXML(string processName, string stepName) 
        {
            return _ref.GetInitialVariable(processName, stepName);
        }
    }
}