<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MidYearEmployeeSubmit.aspx.cs" Inherits="Presale.Process.EmployeePerformanceReport.MidYearEmployeeSubmit" %>
    ...
    <form id="form1" runat="server">
     <div id="myDiv" class="container">
            ...
            <div class="row">
                    ...
                    <ItemTemplate>
                        <table class="table table-condensed table-bordered">
                            ...
                            <tr>
                                ...
                                <td class="td-content" colspan="2" >
                                    <asp:Label runat="server" ID="read_DueDate" Width="96%" Text='<%# String.IsNullOrEmpty(Eval("DueDate").ToString())? "":DateTime.Parse(Eval("DueDate").ToString()).ToString("yyyy-MM-dd") %>'></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="td-label">
                ...
                <p style="font-weight:bold;">Line Manager Comment</p>
                <table class="table table-condensed table-bordered">
                    <tr>
                        <td class="td-label">
                         <span style="height:30px; float:left;">&nbsp;</span>
                        <p style="text-align:center">Feedback on Results-Manager Fill in</p>
                        </td>
                        <td class="td-content" colspan="3" >
                            <asp:Label ID="fld_FORFI" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="td-label"> 
                       <span style="margin-top:5px;  height:30px; float:left;">&nbsp;</span>
                        <p style="text-align:center">Feedback on Behaviors-Manager Fill In</p>
                        </td>
                        <td class="td-content"  colspan="3" >
                            <asp:Label ID="fld_FOBMFI" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="td-label"> 
                       <span style="margin-top:5px;  height:30px; float:left;">&nbsp;</span>
                        <p style="text-align:center">Development Actions-Manager Fill In</p>
                        </td>
                        <td class="td-content"  colspan="3" >
                            <asp:Label ID="read_DAMFI" runat="server"></asp:Label>
                        </td>
                    </tr>
                </table>
                <p style="font-weight:bold;">Employee Comment（"<span style=" background:red;">&nbsp;</span>" must write）</p>
                <table class="table table-condensed table-bordered">
                    <tr>
                        ...
                        <td class="td-content" colspan="7" >
                            <asp:TextBox ID="fld_Comment" runat="server" TextMode="MultiLine" Width="98%" Rows="3" MaxLength="100" CssClass="validate[required]"></asp:TextBox>
                        </td>
                    </tr>
                </table>
            </div>
