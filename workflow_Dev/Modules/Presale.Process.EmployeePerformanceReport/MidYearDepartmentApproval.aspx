<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MidYearDepartmentApproval.aspx.cs" Inherits="Presale.Process.EmployeePerformanceReport.MidYearDepartmentApproval" %>
    ...
    <form id="form1" runat="server">
     <div id="myDiv" class="container">
            ...
            <div class="row">
                ...
                <p style="font-weight:bold;">Line Manager Comment（"<span style=" background:red;">&nbsp;</span>" must write） </p>
                <table class="table table-condensed table-bordered">
                    <tr>
                        ...
                        <td class="td-content" colspan="7" >
                            <asp:TextBox ID="fld_FORFI" runat="server" TextMode="MultiLine" Width="98%" Rows="3" MaxLength="100" CssClass="validate[required]"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="td-label" style="vertical-align:middle"> 
                       <span style="background:red;margin-top:5px;  height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="7" >
                            <asp:TextBox ID="fld_FOBMFI" runat="server" TextMode="MultiLine" Width="98%" Rows="3" MaxLength="100" CssClass="validate[required]"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="td-label" style="vertical-align:middle"> 
                       <span style="background:red;margin-top:5px;  height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content"  colspan="7" >
                            <asp:TextBox ID="fld_DAMFI" runat="server" TextMode="MultiLine" Width="98%" Rows="3" MaxLength="100" CssClass="validate[required]"></asp:TextBox>
                        </td>
                    </tr>
                </table>
