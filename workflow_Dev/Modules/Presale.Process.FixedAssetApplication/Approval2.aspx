            ...
            <div class="row">
                ...
                <table class="table table-condensed table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="td-content">
                            <asp:Label runat="server" ID="read_FATagNo"   style="display:block;"></asp:Label>
                        </td>
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td class="td-content" >
                            <asp:Label runat="server" ID="read_PurchaseTime"    Width="95%"  style="display:block;"></asp:Label>
                        </td>
                        <td class="td-label" > 
                     ...
                     <tr>
                       ...
                       <p style="text-align:center">Net Book Value</p>
                        ...
                        <td class="td-content" >
                            <asp:Label runat="server" ID="read_NetBookValue"   style="display:block;"></asp:Label>
                        </td>
                    </tr>
