<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseApprove.aspx.cs" Inherits="Presale.Process.NewEmployee.PurchaseApprove" %>
    ...
    <script type="text/javascript">
        function beforeSubmit() {
            if ($("#RadioButton1").attr("checked")) {
                $("#fld_PURAdmin").val($("#read_PURM").text());
            }
            if ($("#fld_PURAdmin").val() == "") {
        ...
        $(document).ready(function () {
            ...
            $("#fld_PURTrainDate").val(showTime($("#fld_ATrainDate").val()));
            if ($("#fld_PURAdmin").val() == $("#read_PURM").text()) {
            ...
            <div class="row">
                ...
                <table class="table table-condensed table-bordered">
                    <tr>
                        ...
                        <td class="td-content" colspan="3" >
                            <asp:CheckBox runat="server" ID="RadioButton1" Checked="true"/><asp:Label runat="server" ID="read_PURM" ></asp:Label>
                            <asp:TextBox runat="server" ID="fld_PURAdmin" style="display:none;"></asp:TextBox>
                        </td>
                  <%--  </tr>
                    <tr>
                        <td class="td-label">
                        ...
                        <td class="td-content" colspan="3" >
                            <asp:TextBox runat="server" ID="fld_PURTrainDate" Width="96%" CssClass="validate[required]" onclick="WdatePicker({readOnly:false,dateFmt: 'yyyy-MM-dd'})"></asp:TextBox>
                        </td>
                    </tr>
                    <%--<tr>
                         <td class="td-label" style="vertical-align:middle">
