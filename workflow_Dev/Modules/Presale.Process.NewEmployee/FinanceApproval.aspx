<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinanceApproval.aspx.cs" Inherits="Presale.Process.NewEmployee.FinanceApproval" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#fld_FinanceTrainDate").val(showTime($("#fld_FinanceTrainDate").val()));
            if ($("#fld_FinanceAdmin").val() == $("#read_FINM").text()) {
            ...
            <div class="row">
                ...
                <table class="table table-condensed table-bordered">
                    <tr>
                        ...
                        <td class="td-content">
                            <asp:CheckBox runat="server" ID="RadioButton1" Checked="true" /><asp:Label runat="server" ID="read_FINM" ></asp:Label>
                    ...
                    <tr>
                        ...
                        <td class="td-content">
                            <asp:TextBox runat="server" ID="fld_FinanceTrainDate" Width="96%" CssClass="validate[required]" onclick="WdatePicker({readOnly:false,dateFmt: 'yyyy-MM-dd'})"></asp:TextBox>
                        </td>
                    </tr>
                    <%--<tr>
                         <td class="td-label" style="vertical-align:middle">
