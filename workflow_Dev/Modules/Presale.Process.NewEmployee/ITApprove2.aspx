<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ITApprove2.aspx.cs" Inherits="Presale.Process.NewEmployee.ITApprove2" %>
    ...
    <script type="text/javascript">
        function beforeSubmit() {
            if ($("#RadioButton1").attr("checked")) {
                $("#fld_ITAdmin2").val($("#read_ITM").text());
            }
            if ($("#fld_ITAdmin2").val() == "") {
        ...
        $(document).ready(function () {
            $("#fld_ITTrainDate").val(showTime($("#fld_ITTrainDate").val()));
            $("#read_OBDate").text(showTime($("#read_OBDate").text()));
            if ($("#fld_ITAdmin2").val() == $("#read_ITM").text()) {
            ...
            <div class="row">
                ...
                <table class="table table-condensed table-bordered">
                    <tr>
                        ...
                        <td class="td-content" colspan="3" >
                            <asp:CheckBox runat="server" ID="RadioButton1" Checked="true"/><asp:Label runat="server" ID="read_ITM" ></asp:Label>
                            <%--<asp:RadioButton  runat="server" ID="RadioButton2" GroupName="ITAdmin" Value="Andy.Chu" onclick="getButtonCheck(this,2)" />Andy.Chu--%>
                            <asp:TextBox runat="server" ID="fld_ITAdmin2" style="display:none;"></asp:TextBox>
                        </td>
                    <%--</tr>
                        <tr>
                        <td class="td-label">
                        ...
                        <td class="td-content" colspan="3" >
                            <asp:TextBox runat="server" ID="fld_ITTrainPlace" Width="96%" CssClass="validate[required]"></asp:TextBox>
                        </td>--%>
                        <td class="td-label">
                         <span style=" background:red;  height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content" colspan="3" >
                            <asp:TextBox runat="server" ID="fld_ITTrainDate" Width="96%" CssClass="validate[required]" onclick="WdatePicker({readOnly:false,dateFmt: 'yyyy-MM-dd'})"></asp:TextBox>
                        </td>
                    </tr>
                    <%--<tr>
                         <td class="td-label" style="vertical-align:middle">
                        ...
                        <td class="td-content" colspan="7" >
                        <asp:TextBox runat="server" ID="fld_ITTrainContent" Rows="3" TextMode="MultiLine" Width="98%"  CssClass="validate[required]"></asp:TextBox>
                        </td>
                    </tr>--%>
                </table>
            </div>
