<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ITApproval.aspx.cs" Inherits="Presale.Process.NewEmployee.ITApproval" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if ($("#fld_ITAdmin").val() == $("#read_ITM").text()) {
