<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminApprove.aspx.cs" Inherits="Presale.Process.NewEmployee.AdminApprove" %>
    ...
    <script type="text/javascript">
        function beforeSubmit() {
            if ($("#RadioButton1").attr("checked")) {
                $("#fld_Admin2").val($("#read_AdminORG").text());
            }
            if ($("#fld_Admin2").val() == "") {
        ...
        $(document).ready(function () {
            ...
            $("#fld_ATrainDate").val(showTime($("#fld_ATrainDate").val()));
            if ($("#fld_Admin2").val() == $("#read_AdminORG").text()) {
                ...
                <table class="table table-condensed table-bordered">
                    <tr>
                        ...
                        <td class="td-content" colspan="3" >
                            ...
                            <asp:TextBox runat="server" ID="fld_Admin2" style="display:none;"></asp:TextBox>
                        </td>
                  <%--  </tr>
                    <tr>
                        <td class="td-label">
