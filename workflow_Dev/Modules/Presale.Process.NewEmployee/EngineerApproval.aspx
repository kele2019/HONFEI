<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EngineerApproval.aspx.cs" Inherits="Presale.Process.NewEmployee.HRGApproval" %>
    ...
    <script type="text/javascript">
        function beforeSubmit() {
            if ($("#RadioButton1").attr("checked")) {
                $("#fld_EngineerAdmin").val($("#read_CTO").text());
            }
            if ($("fld_EngineerAdmin").val() == "") {
        ...
        $(document).ready(function () {
            ...
            $("#fld_EngineerTrainDate").val(showTime($("#fld_EngineerTrainDate").val()));
            if ($("#fld_EngineerAdmin").val() == $("#read_CTO").text()) {
            ...
            <div class="row">
                ...
                <table class="table table-condensed table-bordered">
                    <tr>
                        ...
                        <td class="td-content" colspan="3" >
                            <asp:CheckBox runat="server" ID="RadioButton1" Checked="true"/><asp:Label runat="server" ID="read_CTO" ></asp:Label>
                            <%--<asp:RadioButton  runat="server" ID="RadioButton2" GroupName="HRGAdmin" Value="Jason.Hu" onclick="getButtonCheck(this,2)" />Jason.Hu--%>
                            <asp:TextBox runat="server" ID="fld_EngineerAdmin" style="display:none;"></asp:TextBox>
                        </td>
                    <%--</tr>
                    <tr>
                        <td class="td-label">
                        ...
                        <td class="td-content" colspan="3" >
                            <asp:TextBox runat="server" ID="fld_EngineerTrainPlace" Width="96%" CssClass="validate[required]"></asp:TextBox>
                        </td>--%>
                        <td class="td-label">
                         <span style=" background:red;  height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content" colspan="3" >
                            <asp:TextBox runat="server" ID="fld_EngineerTrainDate" Width="96%" CssClass="validate[required]" onclick="WdatePicker({readOnly:false,dateFmt: 'yyyy-MM-dd'})"></asp:TextBox>
                        </td>
                    </tr>
                   <%-- <tr>
                         <td class="td-label" style="vertical-align:middle">
                        ...
                        <td class="td-content" colspan="7" >
                        <asp:TextBox runat="server" ID="fld_EngineerTrainContent" Rows="3" TextMode="MultiLine" Width="98%"  CssClass="validate[required]"></asp:TextBox>
                        </td>
                    </tr>--%>
                </table>
            </div>
