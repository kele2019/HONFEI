<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HRApproval.aspx.cs" Inherits="Presale.Process.NewEmployee.HRApproval" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#fld_HRTrainDate").val(showTime($("#fld_HRTrainDate").val()));
            if ($("#fld_HRAdmin").val() == $("#read_HR").text()) {
            ...
            <div class="row">
                ...
                <table class="table table-condensed table-bordered">
                    <tr>
                        ...
                        <td class="td-content" colspan="3" >
                            <asp:CheckBox runat="server" ID="RadioButton1" Checked="true"/><asp:Label runat="server" ID="read_HR" ></asp:Label>
                            <asp:TextBox runat="server" ID="fld_HRAdmin" style="display:none;"></asp:TextBox>
                        </td>
                  <%--  </tr>
                    <tr>
                        <td class="td-label">
                        ...
                        <td class="td-content" colspan="3" >
                            <asp:TextBox runat="server" ID="fld_HRTrainPlace" Width="96%" CssClass="validate[required]"></asp:TextBox>
                        </td>--%>
                        <td class="td-label">
                         <span style=" background:red;  height:30px; float:left;">&nbsp;</span>
                        ...
                        <td class="td-content" colspan="3" >
                            <asp:TextBox runat="server" ID="fld_HRTrainDate" Width="96%" CssClass="validate[required]" onclick="WdatePicker({readOnly:false,dateFmt: 'yyyy-MM-dd'})"></asp:TextBox>
                        </td>
                    </tr>
                    <%--<tr>
                         <td class="td-label" style="vertical-align:middle">
                        ...
                        <td class="td-content" colspan="7" >
                        <asp:TextBox runat="server" ID="fld_HRTrainContent" Rows="3" TextMode="MultiLine" Width="98%"  CssClass="validate[required]"></asp:TextBox>
                        </td>
                    </tr>--%>
                </table>
            </div>
